...
/***/ (function(module, exports, __webpack_require__) {
	 ...
	 * @param {Boolean=} usageBuffer Whether this buffer attribute should be marked as usage or not.
	 * @param {Function=} arrayType     A reference to a TypedArray constructor. Defaults to Float32Array if none provided.
	 */
	SPE.ShaderAttribute = function( type, usageBuffer, arrayType ) {
		'use strict';
	...
	SPE.ShaderAttribute.prototype.resetusage = function() {
		'use strict';
		this.bufferAttribute.usage = this.usageBuffer ?
			THREE.usageDrawUsage :
	...
	SPE.ShaderAttribute.prototype.forceUpdateAll = function() {
		...
		// this.bufferAttribute.usage = false;
		// this.bufferAttribute.usage = this.usageBuffer ?
		// 	THREE.usageDrawUsage :
		// 	THREE.StaticDrawUsage;
	...
	SPE.ShaderAttribute.prototype._createBufferAttribute = function( size ) {
		...
		if ( this.bufferAttribute !== null ) {
			...
			// Since THREE.js version 81, usage count calculation was removed
	...
	SPE.Group = function( options ) {
	    ...
	    this._attributesNeedusageReset = false;
	...
	SPE.Group.prototype.tick = function( dt ) {
	    ...
	    // then the usage properties of each buffer
	    // attribute will need to be reset back to
	    // what they should be.
	    if ( this._attributesNeedusageReset === true ) {
	        i = this.attributeCount - 1;

	        for ( i; i >= 0; --i ) {
	            attrs[ keys[ i ] ].resetusage();
	        }
	    ...
	    if ( this._attributesNeedRefresh === true ) {
	        ...
	        this._attributesNeedRefresh = false;
	        this._attributesNeedusageReset = true;
	    }
	};
